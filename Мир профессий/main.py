...
def create_question_buttons(screen, question_data, profession, level):
    ...
    button1 = Button(screen, 320, 100, 
        pygame.image.load(resource_path(f"app/assets/images/{random.choice(colors.BUTTON_COLORS)}_button.png")),
        pygame.image.load(resource_path(f"app/assets/images/{random.choice(colors.BUTTON_COLORS)}_button_hover.png")),
        answers[0], 
...
def check_answer(profession, level, button_text, screen):
    ...
    if question_file:
        with open(resource_path(f"app/assets/json/{question_file}"), "r", encoding='utf-8') as f:
...
def main():
    ...
    pygame.display.set_icon(pygame.image.load(resource_path("app/assets/images/icon.png")))
    screen.fill(colors.BLACK)

    play_Button = Button(screen, 320, 130,
        pygame.image.load(resource_path("app/assets/images/green_button.png")), 
        pygame.image.load(resource_path("app/assets/images/green_button_hover.png")), 
        "Играть", 
        lambda: playButtonClicked.playButtonClicked(), 
        150, 50)
    github_button = githubButton.GithubButton(screen, 605, 445, 
        pygame.image.load(resource_path("app/assets/images/github_button.png")), 
        pygame.image.load(resource_path("app/assets/images/github_button_hover.png")))
    ...
    profession_builder = Button(screen, 150, 270,
        pygame.image.load(resource_path("app/assets/images/orange_button.png")), 
        pygame.image.load(resource_path("app/assets/images/orange_button_hover.png")), 
        "Строитель", 
        lambda: genrerate_questions.select_prof(2), 
        150, 50)
    profession_builder.set_delay(0.3)
    profession_banker = Button(screen, 150, 340,
        pygame.image.load(resource_path("app/assets/images/red_button.png")), 
        pygame.image.load(resource_path("app/assets/images/red_button_hover.png")), 
        "Банкир", 
    ...
    level_2 = Button(screen, 320, 270,
        pygame.image.load(resource_path("app/assets/images/yellow_button.png")), 
        pygame.image.load(resource_path("app/assets/images/yellow_button_hover.png")), 
        "Уровень 2", 
